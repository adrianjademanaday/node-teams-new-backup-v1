...
const SHOWING_BOARDINGS = 'Showing Origins';
const SHOWING_ALIGHTINGS = 'Showing Destinations';
...
app.controller('showCtrl', function($scope, $http) {		
	...
	$scope.loadReport = function() {
		...
		if (isValid) {
			$http.get('/reports/vehicleOriginDestinations/fetch?' + 'routeId= ' + routeId + '&hourId=' + hourId + '&sampleNumber=' + sampleNumber)
			.success(function(data) {
