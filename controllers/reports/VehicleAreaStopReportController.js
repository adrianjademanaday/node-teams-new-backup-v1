...
/**
 * 
 * Shows the query page for Vehicle Area Stops Report.
 * 
 */

exports.show = function(req, res) {
	Area.find({}, null, {sort: {name: 1}}, function(err, areas) {
		res.render('reports/vehicleAreaStops/show', {
			areas: areas,
	 		areaId: null,
	 		outputFilename: null
	 	});	
...
exports.fetch = function(req, res) {
	...
	var outputFilePath = OUTPUT_DIR + batchDirectory + '/' + outputFilename + '-vehicleAreaStops.csv';
...
/**
 * 
 * Fetches the Vehicle Area Stops data of a given area.
 * 
 */
...
function getAreaStopsDetails(argumentsPackage) {
	...
	VehicleAreaStop.find({area: area}, null, {sort: {name: 1}}, function(err, areaStops) {
...
/**
 * 
 * Creates Vehicle AreaStop csv data from AreaStops data.
 * 
 */
...
/**
 * 
 * Create the actual Vehicle AreaStop csv file.
 * 
 */
