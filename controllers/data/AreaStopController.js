...
module.exports.initUpload = function(req, res) {
	...
	Area.find({}, null, {sort: {name: 1}}, function(err, areas) {
		res.render('data/areaStop/upload', {
			areas: areas,
	 		areaId: null,
...
/**
 * 
 * Handles the request for processing SurveyData into Passenger AreaStops
 * 
 */
...
module.exports.upload = function(req, res) {
	...
	var topLeftBoundsLat = parseFloat(req.body.topLeftBoundsLat);
 	...
 	areaStopService.process(argumentsPackage)
 	.then(renderResponse)
 	.done();
}
...
function renderResponse(argumentsPackage) {
	...
	res.render('data/areaStop/results', {
